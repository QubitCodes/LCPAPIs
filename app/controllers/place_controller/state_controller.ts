...
export default class PlaceController {
   ...
   */
  public async getStatesWithDistricts({ response }: HttpContext) {
    try {
   ...
   */
  public async getAllStates({ response }: HttpContext) {
    try {
  ...
  public async getAllDistrictsByIdExample({ request, response }: HttpContext) {
    try {
   ...
   */
  public async getAllDistrictsById({ request, response }: HttpContext) {
    try {
      const districts = await District.query()
