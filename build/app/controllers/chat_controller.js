...
export default class ChatController {
     ...
     */
    async getRoomMessages({ request, response }) {
     ...
     */
    async getPrivateMessages({ request, response, auth }) {
     ...
     */
    async getUnreadCount({ response, auth }) {
        const user = auth.user;
     ...
     */
    async searchMessages({ request, response, auth }) {
        const user = auth.user;
     ...
     */
    async deleteMessage({ params, response, auth }) {
        const user = auth.user;
