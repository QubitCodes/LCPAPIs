...
app.ready(() => {
    ...
    const io = new Server(nodeServer, {
        cors: {
            origin: process.env.FRONT_END_URL || 'http://localhost:3000' || 'cyber-fort-web-admin.vercel.app', // your frontend URL in dev
            credentials: true,
            methods: ['GET', 'POST'],
        },
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('private:typing', (data) => {
            ...
            if (recipientSocketId) {
                ...
                console.log(`⌨️  User ${userId} is ${data.isTyping ? 'typing' : 'stopped typing'} to ${data.to}`);
            }
            else {
